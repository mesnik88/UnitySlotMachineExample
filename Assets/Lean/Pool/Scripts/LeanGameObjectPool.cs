...
namespace Lean.Pool
{
    ...
    public class LeanGameObjectPool : MonoBehaviour
    {
            ...
            if (Prefab != null)
            {
                ...
                while (despawnedClones.Count > 0)
                {
                    ...
                    if (clone.GameObject != null)
                    {
                        ...
                        if (clone.GameObject.GetComponent<Initable>() != null) clone.GameObject.GetComponent<Initable>().DeInit();
        ...
        public void Despawn(GameObject cloneGameObject, float t = 0.0f)
        {
            ...
            {
                if (cloneGameObject.GetComponent<Initable>() != null) cloneGameObject.GetComponent<Initable>().DeInit();
                // Delay the despawn?
                if (t > 0.0f)
                {
